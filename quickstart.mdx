...
<AccordionGroup>
  <Accordion icon="copy" title="Get Admin access to your site">
    During the onboarding process, we will send you your Admmin credentials within 24 hours of us receiving the SOW.
    Sign in using your credentials.
    You will be sent an OTP to your registered email box.
    Put the OTP in the next screen and you should be able to access the Admin panel for your White Branded OTT site.
  </Accordion>
</AccordionGroup>
